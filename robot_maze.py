...
# 
# - **环境** : 迷宫，有红色炸弹和蓝色目标
# - **状态** : 遇墙，陷入陷阱，到达终点，其他情况
# 
# 
# - **动作** : 上下左右
# - **奖励** : 撞墙-10，走到终点+50，走到陷阱-30，其他情况-0.1
# 
# $$T(s^{'}, a, s) = P(s^{'}|a,s)$$
# 
# 
...
def choose_action(epsilon):
    ...
    action = None
    if random.random(0,1) < epsilon: # 以某一概率
...
## todo: 创建迷宫并展示
maze = Maze(maze_size=(10, 11), trap_number=5)
...
## 循环、随机移动机器人10次，记录下奖励
for i in range(10):
    rewards.append(maze.move_robot(random.choice(actions)))
